        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex justify-center text-teal-600  sm:justify-start">
              ...
              <Link
                to="/"
                className="btn btn-ghost normal-case lg:text-3xl text-2xl lg:ml-0 ml-5 lg:mt-0 -mt-2"
              >
                TutoFind
              </Link>
            </div>
            ...
            <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:mx-0 sm:max-w-xs sm:text-left">
              Best Tutors provider in Bangladesh is here.
            </p>
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-teal-700 transition hover:text-teal-500/75"
                >
            ...
            <div className="text-center sm:text-left">
              ...
              <nav aria-label="Footer About Nav" className="mt-8">
                <ul className="space-y-4 text-sm">
                  <li>
                    <a
                      className="text-gray-700 transition hover:text-gray-700/75  hover:/75"
                      href="/"
                    >
                      Company History
                    </a>
                ...
                <ul className="space-y-4 text-sm">
                  ...
                  <li>
                    <a
                      ...
                      href="/"
                    >
                      <span className="text-gray-700 transition group-hover:text-gray-700/75  hover:/75">
                        Live Chat
                      </span>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  ...
                  >
                    ...
                    <span className="text-gray-700">tutofind@support.com</span>
                  </a>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="">0170000000</span>
                  </a>
                </li>
